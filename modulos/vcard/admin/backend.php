...
//}
    ...
    $imagen=($cover!='')?'<td class="text-center"><img src="'.$page_url.'modulos/'.$mod.'/fotos/'.$cover.'" alt="Product Image" class="img-rounded" width="60"></td>':'';
    $listado.='
      <tr>
    ...
    $listado.='
      <div class="col-md-3 col-xs-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="ima-size">
              <img src="'.$page_url.'modulos/'.$mod.'/fotos/'.$logo.'" class="img-responsive ima-size">
            </div>
